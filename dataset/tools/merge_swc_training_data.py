...
DEFAULT_TRAINING = str(PROJECT_ROOT / "dataset" / "auxiliary" / "dappscan" / "training_data_functions_only_cleaned.json")
DEFAULT_SWC      = str(PROJECT_ROOT / "dataset" / "swc_registry.json")
DEFAULT_OUTPUT   = str(PROJECT_ROOT / "dataset" / "processed" / "merged_training_data.json")
