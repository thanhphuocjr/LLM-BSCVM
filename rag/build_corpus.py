...
DEFAULT_SOLODIT_PATH = PROJECT_ROOT / "dataset" / "raw" / "solodit" / "solodit.json"
DEFAULT_DAPPSCAN_PATH = PROJECT_ROOT / "dataset" / "raw" / "dappscan" / "dappscan.json"
DEFAULT_OUTPUT_PATH = PROJECT_ROOT / "dataset" / "processed" / "smart_contract_corpus.json"
...
def main():
    solodit_path = str(DEFAULT_SOLODIT_PATH)
    dappscan_path = str(DEFAULT_DAPPSCAN_PATH)
