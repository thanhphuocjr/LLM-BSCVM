...
DAPPSCAN_PATH   = DATASET_DIR / "raw" / "dappscan" / "dappscan.json"
EXTRA_PATH      = DATASET_DIR / "auxiliary" / "dappscan" / "extra_swc_samples.json"
REGISTRY_PATH   = DATASET_DIR / "swc_registry.json"
OUTPUT_PATH     = DATASET_DIR / "processed" / "merged_dappscan_dataset.json"
